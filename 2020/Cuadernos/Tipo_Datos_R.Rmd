...
author: Isaac Zainea, Daniel Montenegro & Luis Campos
output: 
  ioslides_presentation:
    widescreen: true
    #css: JB_style.css
    #logo: <img src="https://github.com/lacamposm860624/Curso-RYP-Ucentral/blob/master/IMG/Imgs/LogoCurso.png?raw=true"  >
...
<img src="https://github.com/lacamposm860624/Curso-RYP-Ucentral/blob/master/IMG/Imgs/scan.png?raw=true" >
</div>
...
<div class = "aligncenter">
<img src="https://github.com/lacamposm860624/Curso-RYP-Ucentral/blob/master/IMG/Imgs/studytime.png?raw=true" >
</div>
...
- Investigar la documentación de la función `sort` (recordemos que podemos usar la sintaxis `?sort` en la consola) para leer si cambiando algún argumento de la misma podemos obtener el mismo resultado que haber programado en el primer ejercicio.
